...
public class VirtualPetShelterApp {
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            System.out.println(petD.getName() + " " + petD.getHunger() + " " + petD.getSleepy() + " " + petD.getBored());
            System.out.println(petE.getName() + " " + petE.getHunger() + " " + petE.getSleepy() + " " + petE.getBored());
